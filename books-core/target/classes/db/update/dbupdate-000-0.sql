...
create cached table T_COMMON_LIBRARY_USERBOOK ( CL_USERBOOK_ID varchar(255) not null, CL_USERBOOK_RATING double , primary key (CL_USERBOOK_ID) );
create cached table T_COMMON_LIBRARY ( CL_BOOK_ID  varchar(36) not null, CL_BOOK_TITLE varchar(255) not null,CL_SUBTITLE varchar(255), CL_BOOK_AUTHOR varchar(255) not null,  CL_DESCRIPTION varchar(4000), CL_BOOK_GENRE varchar(255), CL_BOOK_RATING double, CL_BOOK_N_RATING integer,CL_ISBN10 varchar(10), CL_ISBN13 varchar(13), CL_PAGECOUNT integer, CL_LANGUAGE varchar(2), CL_PUBLISHDATE datetime, primary key (CL_BOOK_ID) ); 
create cached table T_PODCAST ( POD_ID_C varchar(36) not null, POD_USER_ID_C varchar(36) not null, POD_AUDIO_URL_C varchar(255) not null, POD_IMAGE_URL_C varchar(255) not null, POD_NAME_C varchar(255) not null, POD_PROVIDER_C varchar(255) not null, primary key (POD_ID_C) );
create cached table T_AUDIOBOOK ( AB_ID_C varchar(36) not null, AB_USER_ID_C varchar(36) not null, AB_AUTHOR_C varchar(255) not null, AB_PREVIEW_URL_C varchar(255) not null, AB_IMAGE_URL_C varchar(255) not null, AB_NAME_C varchar(255) not null, AB_DESCRIPTION_C varchar(4000) not null, AB_NARRATOR_C varchar(255) not null, AB_PROVIDER_C varchar(255) not null, primary key (AB_ID_C) );

...
import com.sismics.books.core.service.facebook.FacebookServiceException;
...
public class FacebookService extends AbstractScheduledService {
     ...
     */
    public String getExtendedAccessToken(String accessToken) throws FacebookServiceException {
        ...
        try {
            ...
            if (e.getMessage().contains("Error validating access token")) {
                throw new FacebookServiceException("Error validating access token");
            }
     ...
     */
    public void validatePermission(String accessToken) throws FacebookServiceException {
        FacebookClient facebookClient = new DefaultFacebookClient(accessToken);
        ...
        if (!installed) {
            throw new FacebookServiceException("Permission not found: installed");
        }
        if (!email) {
            throw new FacebookServiceException("Permission not found: email");
        }
        if (!publishStream) {
            throw new FacebookServiceException("Permission not found: publish_stream");
        }
        if (!readStream) {
            throw new FacebookServiceException("Permission not found: read_stream");
        }
    }
